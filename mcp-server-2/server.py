"""MCP сервер для сравнения репозиториев GitHub."""
...
from tools.comparison_tool import compare_repositories
...
def main():
    ...
    print(f"📊 Сервер: GitHub Repository Comparison Utility")
    print(f"🔧 Инструменты:")
    print(f"   - compare_repositories")
