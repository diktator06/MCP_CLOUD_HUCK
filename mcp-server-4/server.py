...
from tools.code_search import search_code_in_repository
...
def main():
    ...
    print(f"📊 Сервер: GitHub Code Search & Analysis")
    print(f"🔧 Инструменты:")
    print(f"   - search_code_in_repository")
    print(f"   - get_file_tree")
    print(f"   - analyze_dependencies")
